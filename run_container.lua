...
local build_command = "podman build -t python3.12-fastapi-sqlalchemy:latest ."
...
local run_command = string.format(
    ...
    "--replace --name python3.12-fastapi-sqlalchemy python3.12-fastapi-sqlalchemy:latest",
